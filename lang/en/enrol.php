...
$string['youunenrolledfromcourse'] = 'You are unenrolled from the course.';
$string['userunenrolledfromcourse'] = 'User "{$a}" was unenrolled from the course.';
$string['youenrolledincourse'] = 'You are enrolled in the course.';
$string['userenrolledincourse'] = 'User "{$a}" was enrolled in the course.';
